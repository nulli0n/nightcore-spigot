...
public class LangManager extends SimpleManager<NightCorePlugin> {
    ...
    protected void onLoad() {
        ...
        String realCode = this.extractConfig(langCode);
        this.config = new FileConfig(this.plugin.getDataFolder() + DIR_LANG, this.getFileName(realCode));
    }
    ...
    @NotNull
    private String extractConfig(@NotNull String langCode) {
